...
VALUES
    ('CTso000001', N'Công ty Ánh Viên', N'giao dịch bitcoin', N'Địa chỉ A', '0123456789', '0987654321', 'emailA@gmail.com'),
    ('CTso000002', N'Công ty B', N'Giao dịch VINAMILK', N'Địa chỉ B', '0123756789', '0987654322', 'emailB@gmail.com'),
    ('CTso000003', N'Công ty Hoa Sen', N'giao dịch ví điện tử', N'Địa chỉ D', '0193457787', '0987654323', 'emailC@gmail.com'),
	('CTso000004', N'Việt Tiến', N'giao dịch thương mại', N'Địa chỉ B', '0193457788', '0987694323', 'emailD@gmail.com'),
	('CTso000005', N'Công ty A', N'VINAMILK', N'Địa chỉ C', '0193457773', '0987604323', 'emailE@gmail.com'),
	('CTso000006', N'Công ty VINAMILK', N'VINAMILK', N'Địa chỉ C', '0193459887', '0980650323', 'emailF@gmail.com'),
	('CTso000007', N'Công ty C', N'Giao dịch thanh toán qua app', N'Địa chỉ A', '0193459987', '0987054323', 'emailG@gmail.com'),
	('CTso000008', N'Công ty B', N'Giao dịch tiền mặt', N'Địa chỉ E', '0197457787', '0987604023', 'emailH@gmail.com'),
	('CTso000009', N'Công ty C', N'VINAMILK', N'Địa chỉ F', '0103457787', '0987650323', 'emailI@gmail.com'),
...
INSERT INTO MATHANG
VALUES 
	('MH00000001', N'Tivi Sony', 'CTso000001', 'LHso000001', 49, N'Máy', 5000000),
...
VALUES
	...
	('SHD0000002', 'khso000001', 'nvso000002', '21-3-2022', '23-3-2022', '22-3-2022', null),
	('SHD0000003', 'khso000002', 'nvso000003', '21-4-2022', '23-4-2022', null, null),
	('SHD0000004', 'khso000003', 'nvso000004', '21-5-2022', '23-5-2022', '22-5-2022', N'100 Lê Độ'),
	('SHD0000005', 'khso000004', 'nvso000005', '21-6-2022', '23-6-2022', null, N'99 Hà Huy Tập'),
	('SHD0000006', 'khso000005', 'nvso000005', '21-7-2022', '23-7-2022', '22-7-2022', N'13/48 Dương Thành Long'),
	('SHD0000007', 'khso000003', 'nvso000006', '21-8-2022', '23-8-2022', '22-8-2022',null),
	('SHD0000008', 'khso000004', 'nvso000007', '21-9-2022', '23-9-2022', '22-9-2022', N'78 Thọ Khang'),
	('SHD0000009', 'khso000006', 'nvso000008', '21-10-2022', '23-10-2022', '22-10-2022', N'12 Tôn Đản'),
	('SHD0000010', 'khso000007', 'nvso000002', '21-11-2022', '23-11-2022', '22-11-2022', N'90 Dinh Độc Lập')
...
SELECT  HO + ' ' + TEN AS HOVA_TEN,  DIACHI,  YEAR(NGAYLAMVIEC) AS NAM_BAT_DAU_LAM_VIEC
FROM NHANVIEN;

--2. Công ty [Việt Tiến] đã cung cấp những mặt hàng nào?
SELECT TENHANG 
FROM MATHANG 
WHERE NHACUNGCAPNO = (SELECT MACONGTY 
	                FROM NHACUNGCAP 
...
SELECT TENCONGTY, TENGIAODICH
FROM KHACHHANG 
WHERE TENGIAODICH IN (SELECT TENGIAODICH 
                      FROM NHACUNGCAP 
...
SELECT HO + ' ' + TEN AS HOVA_TEN 
FROM NHANVIEN 
WHERE MANHANVIEN NOT IN (SELECT DISTINCT MANHANVIEN 
                         FROM DONDATHANG);
select *
from DONDATHANG
select *
...
SELECT MANHANVIEN, 
    (SELECT COUNT(*) FROM DONDATHANG,NHANVIEN WHERE DONDATHANG.MANHANVIEN = NHANVIEN.MANHANVIEN) AS SO_LUONG_DON
FROM 
    NHANVIEN;
	SELECT MANHANVIEN, 
       COALESCE((SELECT COUNT(*) 
                 FROM DONDATHANG 
                 WHERE DONDATHANG.MANHANVIEN = NHANVIEN.MANHANVIEN), 0) AS SO_LUONG_DON
FROM NHANVIEN;

--6. Cho biết tổng số tiền hàng mà cửa hàng thu được trong mỗi tháng của năm 2022 (thời được gian tính theo ngày đặt hàng).
SELECT MONTH(DONDATHANG.NGAYDATHANG) AS THANG, 
       SUM(CHITIETDATHANG.GIABAN * CHITIETDATHANG.SOLUONG) AS TONG_SO_TIEN
FROM DONDATHANG, CHITIETDATHANG
WHERE DONDATHANG.SOHOADON = CHITIETDATHANG.DONDATHANGNO
  AND YEAR(DONDATHANG.NGAYDATHANG) = 2022
...
SELECT MAHANG, TENHANG 
FROM MATHANG
WHERE NHACUNGCAPNO IN (SELECT MACONGTY
                       FROM NHACUNGCAP);
...
SELECT TENGIAODICH AS KHACHHANG, HO + ' ' + TEN AS NHANVIEN, NGAYDATHANG, NOIGIAOHANG
FROM DONDATHANG, KHACHHANG, NHANVIEN
WHERE DONDATHANG.KHACHHANGNO = KHACHHANG.MAKHACHHANG
  AND DONDATHANG.MANHANVIEN = NHANVIEN.MANHANVIEN
  AND DONDATHANG.SOHOADON = 'SHD0000001';
--11.Hãy cho biết số tiền lương mà công ty phải trả cho mỗi nhân viên là bao nhiêu (lương = lương cơ bản + phụ cấp).
SELECT HO + ' ' + TEN AS NHANVIEN, LUONGCOBAN + PHUCAP AS TONGLUONG
FROM NHANVIEN;
